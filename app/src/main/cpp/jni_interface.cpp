...
Java_org_pytorch_demo_YOLOv5_init(JNIEnv* env, jclass, jobject assetManager) {
...
Java_org_pytorch_demo_YOLOv5_detect(JNIEnv* env, jclass, jobject image, jdouble threshold, jdouble nms_threshold) {
    auto result = YoloV5::detector->detect(env,image,threshold,nms_threshold);

    auto box_cls = env->FindClass("org/pytorch/demo/yolo/Box");
